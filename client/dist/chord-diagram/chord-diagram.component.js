...
var ChordComponent = (function () {
    ...
    ChordComponent.prototype.getDefaultLayout = function () {
        // console.log(this.sort);
        return custom_chord_sort_1.default()
            .padAngle(0.025)
    ...
    ChordComponent.prototype.updateChart = function () {
        ...
        var g = svg.select("g"), innerRadius = this.width * .32;
        var tooltip = chart.select("#tooltip");
        var outerRadius = innerRadius * 1.07;
        var arc = d3.arc()
        ...
        // .correctLightness()
        // .domain([0, 2 * Math.PI]);
        var opacityDefault = .8, transDur = 500;
        // const groupSort = parseInt(this.sort);
        var Names = this.data.slice(0, 1)[0];
        var keys = this.data.slice(1, 2)[0];
        var matrix = this.data.slice(2);
        ////////////////////////////////////////////////////////////
        ////////////////// Draw outer Arcs /////////////////////////
        ////////////////////////////////////////////////////////////
